                           ...
                           <form id="loginForm">
                              <div class="row">
                                 ...
                                 <div class="col-lg-12">
                                    ...
                                    <!-- data-parsley-minlength="8" data-parsley-pattern="(?=.*[a-z])(?=.*[A-Z]).*" data-parsley-pattern-message="The password must include at least 1 upper case letter" -->
                                 </div>
                              </div>
                              <div class="d-flex justify-content-center">
                                 <button type="submit" class="btn btn-primary">Sign In</button>
                              </div>
                              <p class="text-center my-3">Not a Admin?</p>
                              <div class="d-flex justify-content-center">
