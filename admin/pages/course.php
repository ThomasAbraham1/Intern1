        ...
        <form id="createCourseForm">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" id="courseName" placeholder="Course Name" required>
                </div>
...
<script>
    $(function() {
        $('#createCourseForm').parsley().on('field:validated', function() {
    ...
    $(document).ready(function() {
        $("#createCourseBtn").click(function(e) {
            if ($('#createCourseForm').parsley().isValid()) {
