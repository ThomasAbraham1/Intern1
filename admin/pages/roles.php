                                ...
                                <?php foreach ($permissionRecords as $permissionRecord) {  ?>
                                    <tr class="">
                                        <td class="permissionNameRecord"><label><?php echo $permissionRecord['permissionName'] ?></label>
                                            <div style="float:right;">
                                                <a class="btn btn-sm btn-icon text-primary flex-end permissionEditBtn" permissionId="<?php echo $permissionRecord['permissionId'] ?>" data-bs-toggle="modal" data-bs-target="#editModal" title="Edit Permission" href="#">
                                                    <span class="btn-inner">
                                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M11.4925 2.78906H7.75349C4.67849 2.78906 2.75049 4.96606 2.75049 8.04806V16.3621C2.75049 19.4441 4.66949 21.6211 7.75349 21.6211H16.5775C19.6625 21.6211 21.5815 19.4441 21.5815 16.3621V12.3341" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                                            </path>
        ...
        <div class="modal-content">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="email" class="form-label">Permission Name</label>
                        <input type="text" class="form-control" id="editedPermissionName" aria-describedby="text" value="" placeholder="Permission Title" required>
                    </div>
                    <div class="text-start">
                        <button id="editedPermissionSaveBtn" type="submit" class="btn btn-primary">Save</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                    </div>
                </div>
                <div id="result"></div>
...
<script>
    $(document).ready(function() {
        ...
        // Edit Permissions
        $('.permissionEditBtn').click(function(e) {
            e.preventDefault();

            var permissionId = $(this).attr('permissionId');
            var permissionName = $(this).parent().parent().children(':eq(0)').text();
            $('#editedPermissionName').attr('value', permissionName);

            $('#editedPermissionSaveBtn').unbind().click(function(e) {
                permissionName = $('#editedPermissionName').val();
