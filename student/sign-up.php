                                    ...
                                    <form id='signUpForm'>
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="password" data-parsley-trigger="change" data-parsley-minlength="8" data-parsley-pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d).*" data-parsley-pattern-message="The password must include at least 1 upper, lower case letter and a number" class="form-control" id="password" placeholder=" " required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
